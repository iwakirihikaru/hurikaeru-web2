...
<body>
<div class="nav">ふりかえり WEB接続</div>
<div class="wrap">
  <div class="card">
    <div class="lead">この端末を、先生のふりかえりデータにつなぎます。初回だけここで保存すれば、以後は <span class="mono">student.html</span> からそのまま入れます。</div>
  </div>
  <div class="card">
    <div class="label">初回の流れ</div>
    <ol class="steps">
      <li>先生から受け取った URL を開く</li>
      <li>下の URL が入っていることを確認する</li>
      <li>「保存して接続確認」を押す</li>
      <li>終わったら児童ページを開く</li>
    </ol>
  </div>
  <div class="card">
    <label class="label" for="apiUrl">接続先の GAS Web App URL</label>
    ...
    <div id="status" class="status">まだ保存されていません。</div>
  </div>
  <div class="card">
    <div class="label">いま保存されている接続先</div>

const PORTABLE_ACTION_HANDLERS_ = Object.freeze({
  ...
  studentLoadState: function(unitId, period, num, studentSessionToken) { return normalizePortableStudentStateResult_(studentLoadState(unitId, period, num, studentSessionToken)); },
  getStudentPreviousReview: function(unitId, period, num, studentSessionToken) { return getStudentPreviousReview(unitId, period, num, studentSessionToken); },
  getStudentPastRecords: function(num, unitId, limit, studentSessionToken) { return getStudentPastRecords(num, unitId, limit, studentSessionToken); },
  getTimelineSnapshot: function(lessonId, activeRevision, studentNumber, studentSessionToken) { return getTimelineSnapshot(lessonId, activeRevision, studentNumber, studentSessionToken); },
  getTimeline: function(unitId, period) { return getTimeline(unitId, period); },
  autoSave: function(unitId, period, num, customs, studentSessionToken) { return autoSave(unitId, period, num, customs, studentSessionToken); },
  submitReview: function(unitId, period, num, customs, submitOptions, studentSessionToken) { return submitReview(unitId, period, num, customs, submitOptions, studentSessionToken); },

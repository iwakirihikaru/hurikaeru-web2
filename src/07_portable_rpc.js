const PORTABLE_ACTION_HANDLERS_ = Object.freeze({
  ...
  studentInit: function() { return studentInit(); },
  studentLoadState: function(studentNumber) { return studentLoadState(studentNumber); },
  getStudentPreviousReview: function(studentNumber) { return getStudentPreviousReview(studentNumber); },
  getStudentPastRecords: function(studentNumber) { return getStudentPastRecords(studentNumber); },
  getTimeline: function(studentNumber) { return getTimeline(studentNumber); },
  autoSave: function(studentNo, answers, unitId, period) { return autoSave(studentNo, answers, unitId, period); },
  submitReview: function(studentNo, answers, unitId, period) { return submitReview(studentNo, answers, unitId, period); },

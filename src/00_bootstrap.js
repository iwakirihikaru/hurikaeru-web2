...
const RESPONSE_HEADERS = ['responseId','lessonId','unitId','studentId','studentNumber','studentName','answersJson','reviewText','submitted','submittedAt','score','rank','medal','comment','isRewrite','updatedAt','aiStatus','aiQueuedAt','aiProcessedAt','aiError','aiBatchId','aiRetryCount','aiStartedAt','aiLatencyMs','aiModelLatencyMs'];
const LESSON_LIVE_STATE_HEADERS = ['liveStateId','lessonId','unitId','period','studentId','studentNumber','studentName','responseId','answersJson','reviewText','submitted','submittedAt','score','rank','medal','comment','isRewrite','updatedAt','aiStatus','aiQueuedAt','aiProcessedAt','aiError','aiBatchId','aiRetryCount','aiStartedAt','aiLatencyMs','aiModelLatencyMs'];

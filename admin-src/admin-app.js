const CONFIG = {
  ...
  templateCopyUrlBase: 'https://docs.google.com/spreadsheets/d/1rW5FPPwmlfXbfAIxmVBzMRd8oB0_R4Hb5LOfCF8Jgzk/edit',
  templateCopyChooserUrlBase: 'https://script.google.com/macros/s/AKfycbwo3TBXAkqLSx6XYcXxTI5m34DerRMHaB6X13dymilmU_wmc-Fn5F-2jkNofErLevVo7Q/exec',
  templateProvisionUrlBase: 'https://script.google.com/macros/s/AKfycbxCO7At4So96DUASA3kQGpGZwBHSJyaU00ET4C56tgdpOyfbT7rfhAIAI9QhSGpRlWtag/exec',
  primaryShellConfigUrl: 'https://iwakirihikaru.github.io/hurikaeru/shell-config.json',
  primaryMaintenanceUrl: 'https://iwakirihikaru.github.io/hurikaeru/maintenance-status.json',
  guideModePath: '?mode=guide',
  latestTenantAppBuild: 'shell-config-phase2-2026-07-05-1730',
  latestTenantAppVersion: '357',
